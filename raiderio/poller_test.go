...
func (f *fakeStore) GetItemName(ctx context.Context, itemID int64) (string, error) {
	return "", nil
}
func (f *fakeStore) UpsertItemName(ctx context.Context, itemID int64, name string) error {
	return nil
}
